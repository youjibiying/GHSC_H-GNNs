...
from models.hypergraph_conv import HypergraphConv
...
class HypergraphConv1(MessagePassing):
...
#         Note that add dropout to attention is default in the original paper
        ...
        self.convs.append(HypergraphConv(num_features,
                                         args.MLP_hidden, use_attention=False))
        for _ in range(self.num_layers-2):
            self.convs.append(HypergraphConv(
                args.MLP_hidden, args.MLP_hidden, use_attention=False))
        # Output heads is set to 1 as default
        self.convs.append(HypergraphConv(
            args.MLP_hidden, num_classes, use_attention=False))
